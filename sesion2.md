...
<head>
    ...
    <title>Distribuidora Sigmar</title>
</head>

<body>
    <header>
        <h1><strong>Distribuidora Sigmar</strong></h1>
    </header>

    <main>
        <p>Bienvenidos a la empresa Distribuidora sigmar tenemos una gama de productos dirigidos a la confeccion como
    ...
    <footer>
        <p><span style="color: red;">Copyright 2023-Abner Marulanda </span></p>
        <p>abnermarulanda@gmail.com</p>
    </footer>
</body>
...
<body>
    ...
    <nav>
        <a href="index.html" target="_blank" rel="noopener noreferrer">Inicio</a>
    </nav>
    <footer>
        <p><span style="color: red;">Copyright 2023-Abner Marulanda </span></p>
        <p>abnermarulanda@gmail.com</p>
...
<body>
    ...
    <main>
        ...
        <aside>
            <h3><u>Ubicacion</u></h3>
            <p>Entre calle 51 y calle 50, Cra. 53 #50-29, Medellín, Antioquia tercer piso</p>
        </aside>
        <p>
        <h3><u>Aqui encontraran informacion sobre nuestros servicios y productos</u></h3>
        </p>
